...
const OpenPositions = () => {
    ...
    const populateData = () => {
        if(department === 'Information Technology'){
            ...
            var marketing = careers.jobs.filter(v => {
            ...
            var sales = careers.jobs.filter(v => {
                    ...
                    <div className="section_inner">
                        ...
                        <div className="filters" id='#who'> 
                            <ul>
                                ...
                                {
                                    careers?.jobs?.map(data => {
                                        return(
                                            <li key={data.department_id}>
                                                <a className={department === `${data.department_name}` ? ('filter active') : ('filter')} onClick={() => setDepartment(`${data.department_name}`)}>{data.department}</a>
                                            </li>
                                        )
                                    })
                                }
